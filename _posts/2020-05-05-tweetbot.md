...
>> This bot only tweets from your account. We could also create one for retweeting, favoriting and following. If you want to do that, you just need to change the code in your tweetbot.py file. Checkout this article if you want to do that.
